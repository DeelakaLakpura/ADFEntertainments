<footer class="bg-gray-900">
  <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    ...
    <div class="flex items-center space-x-4">
      <a href="http://localhost/ADFEntertainments" class="transition-transform transform hover:scale-110">
        <img src="./assets/images/logo.png" alt="Logo" class="w-16 h-16 rounded-full shadow-lg" />
      </a>
      <!-- <span class="text-teal-300 text-lg font-semibold">Your Brand Tagline Here</span> -->
    </div>
